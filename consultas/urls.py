...
from .views import NuevaConsultaView, imprimir_bono, ListaBonosView, anular_bono, search_practicas
...
urlpatterns = [
    ...
    # Autocomplete DAL
    path('practicas-search/', search_practicas, name='practicas_search'),
