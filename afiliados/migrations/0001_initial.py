    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuil', models.CharField(blank=True, max_length=255, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monto_coseguro', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='afiliado',
            name='obra_social',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='afiliados', to='afiliados.obrasocial'),
        ),
    ]
